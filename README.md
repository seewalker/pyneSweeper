...
line arguments: 
1. The name which the score will be associated with in score logging.
2. The difficulty. The set of options is currently (Easy, Regular, Difficult,
   Expert). 

   To see a summary of performance, run the script 'stats.py' with the username
